...
Users can control the number of controls that are matched to cases with the ratio argument.  
```{r, eval=FALSE}
...
tot_match = reparse_runs(list(matching_run1,matching_run2), "Mahalanobis", 
                         c("1 case to 1 control", "1 case to 2 controls"))
